...
using Word2Vec.Net.Model;
using Word2Vec.Net.Model.Comparer;
      ...
      using (var writer = new StreamWriter(fs))
      {
        ...
        if (_classes == 0)
        {
          ...
          for (var a = 0; a < _vocabSize; a++)
          {
            ...
            writer.WriteLine($"{_vocab[a].Word}\t{Convert.ToBase64String(bytes.ToArray())}");
          }
        }
        else
        {
