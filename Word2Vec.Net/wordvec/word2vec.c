...
__stdcall void TrainModelWithParameters(            
  			char* trainFileName,
              char* outPutfileName,
              ...
              int windowMode){
			 strcpy(train_file, trainFileName);
			 strcpy(output_file, outPutfileName);
			 strcpy(save_vocab_file, saveVocabFileName);
			 strcpy(read_vocab_file, readVocubFileName);
        layer1_size = size;
